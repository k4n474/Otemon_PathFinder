...
FRONT_STOP_DISTANCE = 120.0
BACKUP_TARGET_DISTANCE = 390.0
CLOCKWISE_BACKUP_TARGET_DISTANCE = 200.0
BACKUP_SPEED = 38.0
FINAL_BACKUP_TARGET_DISTANCE = 435.0
FINAL_BACKUP_SLOWDOWN_DISTANCE = 200.0
FINAL_BACKUP_SPEED = 45.0
FINAL_BACKUP_SLOW_SPEED = 45.0
FINAL_REVERSE_TURN_TARGET_ANGLE = 88.0
...
if __name__ == "__main__":
    try:
        start_parking(RUN_DIRECTION).join()
